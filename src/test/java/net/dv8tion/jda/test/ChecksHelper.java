...
public class ChecksHelper {
    ...
    public static <E extends Enum<E>> EnumChecksAssertions<E> assertEnumChecks(
            String name, ThrowingConsumer<E> callable) {
    ...
    public static <T> CollectionChecksAssertions<T> assertCollectionChecks(
            String name, ThrowingConsumer<Collection<T>> callable) {
